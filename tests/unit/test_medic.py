...
from airos.medic import Medic, MedicError
...
class TestMedicBasics:
    ...
    def test_medic_init_no_callable(self):
        ...
        with patch.dict('os.environ', {}, clear=True):
            with patch('airos.medic._get_providers') as mock_providers:
        ...
        with patch.dict('os.environ', {'GROQ_API_KEY': 'test-key'}):
            with patch('airos.medic._get_providers') as mock_providers:
                ...
                with patch.dict(sys.modules, {'groq': mock_groq_module}):
                    ...
                    import importlib
                    import airos.medic
                    importlib.reload(airos.medic)
                    from airos.medic import Medic as ReloadedMedic
                    medic = ReloadedMedic()
